def execute_search_batch(scenario, planning_problem_set, veh_type_id, 
	...
	path_commonroad_search = "../../commonroad-search"
	...
	from GSMP.motion_automata.automata.MotionAutomata import MotionAutomata
	from GSMP.motion_automata.automata.MotionPrimitive import MotionPrimitive
	from GSMP.motion_automata.automata.States import FinalState

	# load necessary modules and functions
	from GSMP.motion_automata.automata.HelperFunctions import generate_automata, add_initial_state_to_automata
	...
	automata, initial_motion_primitive = add_initial_state_to_automata(automata, planning_problem, flag_print_states = True)
